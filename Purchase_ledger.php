...
<body>
  <div class="account">
    ...
    <h2 class="new_account_heading">Enter Purchase Ledger Transaction</h2>
    <form action="process_ledger.php" method="post">
        ...
        <div class="new_account_buttons ">
            ...
            <a class="btn btn-primary " href="purchase_view_ledger.php" role="button">Back_to-LIST</a>
        </div>
